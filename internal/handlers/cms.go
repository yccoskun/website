...
func (d Deps) ServeMedia(w http.ResponseWriter, r *http.Request) {
	...
	if !public {
		...
		if mismatch {
			...
			securitylog.Event(securitylog.EventSessionBindingMismatch, d.clientIP(r), "route", r.URL.Path)
...
func (d Deps) AdminUploadMedia(w http.ResponseWriter, r *http.Request) {
	...
	securitylog.Default.MediaUpload(d.clientIP(r), r.URL.Path)
...
func (d Deps) AdminDeleteMedia(w http.ResponseWriter, r *http.Request) {
	...
	securitylog.Event(securitylog.EventMediaDelete, d.clientIP(r),
		"route", r.URL.Path,
...
func (d Deps) AdminImport(w http.ResponseWriter, r *http.Request) {
	...
	securitylog.Event(securitylog.EventImport, d.clientIP(r), fields...)
...
func (d Deps) AdminExport(w http.ResponseWriter, r *http.Request) {
	...
	securitylog.Event(securitylog.EventExport, d.clientIP(r), fields...)
